import{g as k,S as D,d as T,s as A,a as P,l as z}from"./main-Vv-HoOlv.js";import{g as C,e as de,c as ue,a as me,S as F,P as U}from"./swiper-BF1HoP9e.js";import"./three-CsQg7oh7.js";function Q(e){const{effect:t,swiper:o,on:a,setTranslate:s,setTransition:c,overwriteParams:n,perspective:r,recreateShadows:i,getEffectParams:m}=e;a("beforeInit",()=>{if(o.params.effect!==t)return;o.classNames.push(`${o.params.containerModifierClass}${t}`),r&&r()&&o.classNames.push(`${o.params.containerModifierClass}3d`);const f=n?n():{};Object.assign(o.params,f),Object.assign(o.originalParams,f)}),a("setTranslate _virtualUpdated",()=>{o.params.effect===t&&s()}),a("setTransition",(f,h)=>{o.params.effect===t&&c(h)}),a("transitionEnd",()=>{if(o.params.effect===t&&i){if(!m||!m().slideShadows)return;o.slides.forEach(f=>{f.querySelectorAll(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").forEach(h=>h.remove())}),i()}});let u;a("virtualUpdate",()=>{o.params.effect===t&&(o.slides.length||(u=!0),requestAnimationFrame(()=>{u&&o.slides&&o.slides.length&&(s(),u=!1)}))})}function K(e,t){const o=C(t);return o!==t&&(o.style.backfaceVisibility="hidden",o.style["-webkit-backface-visibility"]="hidden"),o}function X({swiper:e,duration:t,transformElements:o,allSlides:a}){const{activeIndex:s}=e;if(e.params.virtualTranslate&&t!==0){let c=!1,n;n=o,n.forEach(r=>{de(r,()=>{if(c||!e||e.destroyed)return;c=!0,e.animating=!1;const i=new window.CustomEvent("transitionend",{bubbles:!0,cancelable:!0});e.wrapperEl.dispatchEvent(i)})})}}function Z({swiper:e,extendParams:t,on:o}){t({fadeEffect:{crossFade:!1}}),Q({effect:"fade",swiper:e,on:o,setTranslate:()=>{const{slides:c}=e,n=e.params.fadeEffect;for(let r=0;r<c.length;r+=1){const i=e.slides[r];let u=-i.swiperSlideOffset;e.params.virtualTranslate||(u-=e.translate);let f=0;e.isHorizontal()||(f=u,u=0);const h=e.params.fadeEffect.crossFade?Math.max(1-Math.abs(i.progress),0):1+Math.min(Math.max(i.progress,-1),0),d=K(n,i);d.style.opacity=h,d.style.transform=`translate3d(${u}px, ${f}px, 0px)`}},setTransition:c=>{const n=e.slides.map(r=>C(r));n.forEach(r=>{r.style.transitionDuration=`${c}ms`}),X({swiper:e,duration:c,transformElements:n,allSlides:!0})},overwriteParams:()=>({slidesPerView:1,slidesPerGroup:1,watchSlidesProgress:!0,spaceBetween:0,virtualTranslate:!e.params.cssMode})})}function he(e,t,o){const a=`swiper-slide-shadow${` swiper-slide-shadow-${e}`}`,s=C(t);let c=s.querySelector(`.${a.split(" ").join(".")}`);return c||(c=ue("div",a.split(" ")),s.append(c)),c}function pe({swiper:e,extendParams:t,on:o}){t({creativeEffect:{limitProgress:1,shadowPerProgress:!1,progressMultiplier:1,perspective:!0,prev:{translate:[0,0,0],rotate:[0,0,0],opacity:1,scale:1},next:{translate:[0,0,0],rotate:[0,0,0],opacity:1,scale:1}}});const a=n=>typeof n=="string"?n:`${n}px`;Q({effect:"creative",swiper:e,on:o,setTranslate:()=>{const{slides:n,wrapperEl:r,slidesSizesGrid:i}=e,m=e.params.creativeEffect,{progressMultiplier:u}=m,f=e.params.centeredSlides,h=me(e);if(f){const d=i[0]/2-e.params.slidesOffsetBefore||0;r.style.transform=`translateX(calc(50% - ${d}px))`}for(let d=0;d<n.length;d+=1){const p=n[d],l=p.progress,g=Math.min(Math.max(p.progress,-m.limitProgress),m.limitProgress);let v=g;f||(v=Math.min(Math.max(p.originalProgress,-m.limitProgress),m.limitProgress));const I=p.swiperSlideOffset,b=[e.params.cssMode?-I-e.translate:-I,0,0],M=[0,0,0];let $=!1;e.isHorizontal()||(b[1]=b[0],b[0]=0);let y={translate:[0,0,0],rotate:[0,0,0],scale:1,opacity:1};g<0?(y=m.next,$=!0):g>0&&(y=m.prev,$=!0),b.forEach((q,E)=>{b[E]=`calc(${q}px + (${a(y.translate[E])} * ${Math.abs(g*u)}))`}),M.forEach((q,E)=>{let le=y.rotate[E]*Math.abs(g*u);M[E]=le}),p.style.zIndex=-Math.abs(Math.round(l))+n.length;const se=b.join(", "),re=`rotateX(${h(M[0])}deg) rotateY(${h(M[1])}deg) rotateZ(${h(M[2])}deg)`,ne=v<0?`scale(${1+(1-y.scale)*v*u})`:`scale(${1-(1-y.scale)*v*u})`,ie=v<0?1+(1-y.opacity)*v*u:1-(1-y.opacity)*v*u,ce=`translate3d(${se}) ${re} ${ne}`;if($&&y.shadow||!$){let q=p.querySelector(".swiper-slide-shadow");if(!q&&y.shadow&&(q=he("creative",p)),q){const E=m.shadowPerProgress?g*(1/m.limitProgress):g;q.style.opacity=Math.min(Math.max(Math.abs(E),0),1)}}const _=K(m,p);_.style.transform=ce,_.style.opacity=ie,y.origin&&(_.style.transformOrigin=y.origin)}},setTransition:n=>{const r=e.slides.map(i=>C(i));r.forEach(i=>{i.style.transitionDuration=`${n}ms`,i.querySelectorAll(".swiper-slide-shadow").forEach(m=>{m.style.transitionDuration=`${n}ms`})}),X({swiper:e,duration:n,transformElements:r,allSlides:!0})},perspective:()=>e.params.creativeEffect.perspective,overwriteParams:()=>({watchSlidesProgress:!0,virtualTranslate:!e.params.cssMode})})}k.registerPlugin(D);const B=e=>e.slides[e.activeIndex],O=e=>{if(!e)return;const t=e.querySelector("video");t&&(t.muted=!0,t.play().catch(o=>console.log("Autoplay bloqueado:",o)))},fe=e=>{e.slides.forEach(t=>{const o=t.querySelector("video");o&&(o.pause(),o.currentTime=0)})},ye=()=>{const e=document.querySelector(".swiper-galeria");e&&new F(e,{modules:[pe],direction:"horizontal",slidesPerView:1.8,centeredSlides:!0,loop:!0,effect:"creative",creativeEffect:{prev:{translate:["-130%",40,-200],rotate:[0,0,-10],scale:.8},next:{translate:["130%",40,-200],rotate:[0,0,10],scale:.8}},breakpoints:{1280:{slidesPerView:3}},on:{init(t){const o=B(t);O(o)},slideChangeTransitionStart(t){fe(t)},slideChangeTransitionEnd(t){const o=B(t);O(o)}}})},ge=(e,t=2)=>{const o=document.querySelector(e);if(!o)return;const a=Array.from(o.querySelectorAll("h4"));for(let s=0;s<t;s++)a.forEach(c=>{const n=c.cloneNode(!0);n.classList.add("cloned"),o.appendChild(n)})};function ve({container:e,speed:t=10,direction:o="left",gap:a=40}){const s=document.querySelector(e);if(!s)return;const c=s.querySelector(".marquee");if(!c)return;const n=c.scrollWidth/2;return k.to(c,{x:o==="left"?-n:n,duration:t,ease:"none",repeat:-1})}function we({container:e,speed:t=10,direction:o="left"}){const a=document.querySelector(e);if(!a)return;const s=a.querySelector(".carousel-all--marquee");if(!s)return;Array.from(s.querySelectorAll("picture")).forEach(r=>{const i=r.cloneNode(!0);s.appendChild(i)});const n=s.querySelectorAll("img");Promise.all(Array.from(n).map(r=>r.complete?Promise.resolve():new Promise(i=>{r.onload=i,r.onerror=i}))).then(()=>{const r=s.scrollWidth/2;return k.to(s,{x:o==="left"?-r:r,duration:t,ease:"none",repeat:-1})})}const Se=()=>{k.utils.toArray(".video-section").forEach(e=>{const t=e.querySelector("video");D.create({trigger:e,start:"top 60%",end:"bottom 40%",onEnter:()=>t.play(),onEnterBack:()=>t.play(),onLeave:()=>{t.pause(),t.currentTime=0},onLeaveBack:()=>{t.pause(),t.currentTime=0}})})},be=()=>{Se(),ye(),ge(".marquee",20),ve({container:".expand__image",speed:50}),we({container:".carousel-all",speed:60})};be();let w=null,x=null,L;const j=window.matchMedia("(min-width:1280px)");async function Me(e){try{const t=await fetch(e);if(!t.ok)throw new Error(`HTTP error! status: ${t.status}`);return await t.json()}catch(t){return console.error("Error al cargar el JSON:",t),null}}function ee(e){return{"Extremely confused":"ext-confused",Grateful:"gratefull","Just fine":"just-fine","Happy/Satisfied":"happy-satisfied",Peaceful:"peaceful",Sad:"sad","Extremely Sad":"ext-sad","Excited / Motivated":"exited-motiv",Confused:"confused",Inspired:"inspired","Anxious / Stressed":"anxious-stress","Extremely Happy":"ext-happy","Angry / Resentful":"angry-resent"}[e]||""}function qe(e,t){return`
    ...
    `}function te(e){const t=[];return e.forEach(o=>{Object.keys(o).forEach(a=>{t.push(o[a])})}),t}function Ee(e){return!e||e.length===0?"":`
    ...
    `}function $e(e,t){const o=e.emotions.map(n=>`
    ...
    `:"",s=e.map.map((n,r)=>`
                    ...
                    <div class="col-12 periods-image visualization--fondo">
                        ...
                        <svg viewBox="0 0 1980 1250"  xmlns="http://www.w3.org/2000/svg">
                            <g id="svg-ring" transform="translate(500, 110)">
                                <image href="./img/${e.imagenDesk&&j.matches?e.imagenDesk:e.imagen}" width="980" height="1000" x="0" y="0"></image>
                                ${s}
                            </g>
        ...
        ${e.story?`
                    ...
                    `:""}
    `}function xe(e,t,o){if(!e||!Array.isArray(e)||e.length===0)return"";const a=e.map(d=>d.day),s=Math.min(...a),c=Math.max(...a),n=e.length,r=e[0].date,i=e[e.length-1].date;function m(d,p){const l=new Date(d),g=new Date(p),v=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],I=v[l.getMonth()],b=v[g.getMonth()],M=l.getDate(),$=g.getDate(),y=l.getFullYear();return`${M} ${I} - ${$} ${b}, ${y}`}function u(d){if(!d||d===0||d==="")return"";const p=parseInt(d);return Array(p).fill("<i></i>").join(`
`)}function f(d){const p=new Date(d),l=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];return`${p.getDate()} ${l[p.getMonth()]}`}const h=e.map(d=>{const p=u(d.timesCried);return`
    ...
    `}function Le(e,t){const o=qe(e,t),a=$e(e,t),s=Ee(e.highlights),c=xe(e.data,e.title,e.disclaimer);return`
        ${o}
        ${a}
        ${s}
        ${c}
        
    `}async function Te(){const t=document.querySelector(".swiper-periods").querySelector(".swiper-wrapper");if(!t){console.error("No se encontró .swiper-wrapper");return}return t.innerHTML="",Object.keys(w).forEach(o=>{const a=w[o],s=document.createElement("div");s.className="swiper-slide",s.setAttribute("data-period",o),s.innerHTML=Le(a,o),t.appendChild(s)}),N(),j.addEventListener("change",N),x=new F(".swiper-periods",{modules:[U,Z],effect:"fade",fadeEffect:{crossFade:!0},direction:"horizontal",loop:!1,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0,renderBullet:function(o,a){return'<span class="'+a+'">'+(o+1)+"</span>"}},breakpoints:{1280:{allowTouchMove:!1,autoHeight:!1}},on:{init:function(){const o=this.slides[this.activeIndex];J(o),L=this.activeIndex+1},slideChange:function(){const o=this.slides[this.activeIndex];J(o),L=this.activeIndex+1}}}),x}async function J(e){const t=e.querySelector("#modal-data"),o=e.querySelector(".modal-high"),a=e.querySelector("#modal-resume"),s=document.querySelector("#modal-story"),c=P(),n=e.querySelector(".button.data");if(t&&n){const f=t.querySelector(".close");n.onclick=()=>{t.showModal(),T()},f&&(f.onclick=()=>{t.close()})}const r=e.querySelector(".button.star");if(o&&r){const f=o.querySelector(".close"),h=e.getAttribute("data-period"),d=w[h];f&&(f.onclick=()=>{o.close(),x&&(x.allowTouchMove=!0)});let p=null;r.onclick=()=>{o.showModal(),x&&(x.allowTouchMove=!1),p||(p=new F(o.querySelector(".swiper-high"),{modules:[U,Z],effect:"fade",autoHeight:!0,fadeEffect:{crossFade:!0},direction:"horizontal",spaceBetween:0,loop:!1,pagination:{el:o.querySelector(".swiper-pagination"),clickable:!0}})),T()},te(d.highlights),o.querySelectorAll(".img-ring img")}const i=e.querySelector(".button.read"),m=s.querySelector(".close");if(s&&i&&(i.onclick=()=>{He(L),s.showModal(),T()},m&&(m.onclick=()=>{s.close(),c&&A()})),a){const f=a.querySelector(".button");f&&(f.onclick=()=>{a.close(),c&&A()});const h=a.querySelector("p"),d=a.querySelector("a");d&&h&&(d.onclick=()=>{const p=h.classList.toggle("is-open");d.textContent=p?"Read less":"Read more",d.setAttribute("aria-expanded",p)})}const u=e.querySelector(".periods-hover");u&&(u.onclick=()=>{a&&a.showModal()}),j.matches&&Ae()}const Ie=async()=>{if(w=await Me("./json/periods.json"),!w){console.error("No se pudieron cargar los datos");return}},N=()=>{document.querySelectorAll(".swiper-periods .periods").forEach(t=>{const o=t.querySelector(".periods--botonera"),a=t.querySelector(".periods--data"),s=t.querySelector(".periods--summary"),c=t.querySelector(".button.read");j.matches?(a.insertAdjacentElement("beforeend",o),c&&s.insertAdjacentElement("beforeend",c)):(t.querySelector(".row").insertAdjacentElement("beforeend",o),c&&o.insertAdjacentElement("beforeend",c))})},Ae=()=>{const e=document.querySelectorAll(".periods .yellow-dot");document.querySelector(".visualization"),document.querySelector(".periods-image image");const t=document.querySelectorAll(".head-period--content"),o=document.querySelectorAll(".head-period--map"),a=document.querySelectorAll(".periods--summary"),s=document.querySelectorAll(".swiper-pagination"),c=document.querySelectorAll(".periods--data"),n=document.querySelectorAll(".periods--parrafo"),r=document.querySelectorAll(".svg-flechas"),i=document.querySelectorAll(".svg-flechas-period"),m=document.querySelectorAll(".flechas"),u=h=>{const d=w[L].highlights[h-1][h];o.forEach(p=>{p.querySelector(".head-day").innerHTML=`Day <strong>${d.day}</strong>`,p.querySelector(".head-date").innerHTML=`Date <strong>${d.date}</strong>`,p.querySelector(".head-emotion").innerHTML=`Emotion/Mood <strong>${d.emotion}</strong>`,p.querySelector(".head-location").innerHTML=`Location <strong>${d.location}</strong>`})},f=h=>{w[L].highlights[h-1][h];const d=w[L].map[h-1];n.forEach(p=>{p.innerHTML=`${d.resume?d.resume:""}`,p.classList.add("show",`parrafo-${h}`)})};e.forEach(h=>{let d=h.dataset.map.replace("map-",""),p=h.dataset.flecha;h.addEventListener("mouseenter",()=>{document.querySelectorAll(`.map-hover${d}`).forEach(l=>{l.classList.add("show")}),header.style.visibility="hidden",t.forEach(l=>l.classList.add("hide")),o.forEach(l=>l.classList.add("show")),a.forEach(l=>l.classList.add("hide")),c.forEach(l=>l.classList.add("hide")),s.forEach(l=>l.classList.add("hide")),i.forEach(l=>l.style.display="none"),r.forEach(l=>l.style.display="block"),m.forEach(l=>l.setAttribute("href",`/img/flecha-${p}.webp`)),r.forEach(l=>l.id=`flecha-${p}`),u(parseInt(d)),f(parseInt(d))}),h.addEventListener("mouseleave",()=>{header.style.visibility="visible",document.querySelectorAll(`.map-hover${d}`).forEach(l=>{l.classList.remove("show")}),document.querySelectorAll(".periods--parrafo").forEach(l=>{l.className="periods--parrafo"}),t.forEach(l=>l.classList.remove("hide")),o.forEach(l=>l.classList.remove("show")),a.forEach(l=>l.classList.remove("hide")),c.forEach(l=>l.classList.remove("hide")),s.forEach(l=>l.classList.remove("hide")),m.forEach(l=>l.setAttribute("href","/img/flecha-00.webp")),i.forEach(l=>l.style.display="block"),r.forEach(l=>l.style.display="none")})})},He=e=>{const t=document.querySelector("#modal-story"),o=document.querySelector(".modal--story--meta"),a=document.querySelector(".modal--story--content"),s=w[e];t.querySelector(".title").innerHTML=s.title,o.innerHTML=`<div class="hero__data"><span><strong>${s.fecha}</strong></span></div>
                            <div class="hero__data">
                                <span>Range <strong>${s.rango}</strong></span>
                                <span>Duration<strong>${s.duracion}</strong></span>
                            </div>`,a.innerHTML=s.modalStory};async function oe(){return await Ie(),Te()}let V=null,H;const ae=window.matchMedia("(min-width:1280px)"),W=window.matchMedia("(min-width:1440px)"),G=window.matchMedia("(min-width:1920px)");let S=null;const R=P(),ke=()=>{const e=document.querySelector(".hero-viz"),t=document.querySelector(".visualization"),o=document.querySelector("#btn-viz");t&&o&&(V=()=>{e.classList.add("hide"),t.classList.add("show"),document.querySelector("body").className="panel-3";const a=P();if(!a)return;const s=a.lenisInstance;if(!s)return;const c=document.querySelector("#visualization"),n=c.closest(".pin-spacer")??c;let r=0,i=n;for(;i;)r+=i.offsetTop,i=i.offsetParent;D.refresh(!0),s.scrollTo(r,{immediate:!0})},o.addEventListener("click",V))},Y=()=>{const e=document.querySelector(".link-back");ae.matches?e.innerHTML="Back to Visualization":e.innerHTML="Back"},De=()=>{document.querySelector(".swiper-periods");const e=document.querySelector(".visualization");document.querySelector(".hero-viz");const t=document.querySelector(".main-periods"),o=document.querySelector("#btn-explore"),a=document.querySelector(".visualization--button");if(t&&o){const s=async()=>{e.classList.remove("show"),e.classList.add("hide"),t.classList.add("show"),S=await oe(),await z("#header","componets/header-interior.html"),setTimeout(()=>{H=document.querySelector(".link-back"),H.addEventListener("click",Pe),document.querySelector("body").className="panel-3";const c=P();if(!c)return;const n=c.lenisInstance;if(!n)return;const r=document.querySelector(".main-periods"),i=r.closest(".pin-spacer")??r;let m=0,u=i;for(;u;)m+=u.offsetTop,u=u.offsetParent;D.refresh(!0),n.scrollTo(m,{immediate:!0}),T()},500)};o.addEventListener("click",s),a.addEventListener("click",s)}},Pe=async()=>{const e=document.querySelector(".visualization"),t=document.querySelector(".main-periods");e.classList.add("show"),t.classList.remove("show"),S&&(S.destroy(!0,!0),S=null),await z("#header","componets/header.html"),R&&A()},ze={1:{number:"01",title:"A Promising Year Ahead",fecha:"1 Jan - 11 Feb, 2024",range:"Days 01 to 42",days:"42 days"},2:{number:"02",title:"The trip: 33 days of emotions",fecha:"12 Feb - 15 Mar, 2024",range:"Days 43 to 74",days:"33 days"},3:{number:"03",title:"Back home. Crisis gestation",fecha:"16 Mar - 3 May, 2024",range:"Days 76 to 124",days:"49 days"},4:{number:"04",title:"The Crisis. Where is My Mind?",fecha:"∼ 4 May - 18 Jun, 2024",range:"Days 125 to 170",days:"46 days"},5:{number:"05",title:"The hard work of healing",fecha:"∼ 19 Jun - 30 Aug, 2024",range:"Days 171 to 243",days:"∼73 days"},6:{number:"06",title:"The recovery",fecha:"∼ 31 Aug - 16 Oct, 2024",range:"Days 244 to 290",days:"47 days"},7:{number:"07",title:"New Beginnings",fecha:"∼ 17 Oct - 31 Dec, 2024",range:"Days 291 to 366",days:"76 days"}},Ce=e=>{const t=document.querySelector(".visualization--period--head"),o=document.querySelector(".head-period"),a=ze[e];a&&t&&(t.querySelector("h3").textContent=a.number,t.querySelector("#p-hover-head-1").innerHTML=`<strong>${a.fecha}</strong>`,t.querySelector("#p-hover-head-2").innerHTML=`<span>Range </span><strong>${a.range}</strong>`,t.querySelector("#p-hover-head-3").innerHTML=`<span>Duration </span><strong>${a.days}</strong>`,t.querySelector("h2").textContent=a.title),a&&o&&(o.querySelector("h4").textContent=a.number,o.querySelector(".head-period__data--fecha").innerHTML=`<strong>${a.fecha}</strong>`,o.querySelector(".head-period__data--rango").innerHTML=`Range <strong>${a.range}</strong>`,o.querySelector(".head-period__data--duracion").innerHTML=`Duration <strong>${a.days}</strong>`,o.querySelector(".title").textContent=a.title)},je=async e=>{document.querySelector(".swiper-periods");const t=document.querySelector(".visualization");document.querySelector(".hero-viz");const o=document.querySelector(".main-periods");if(document.querySelector(".visualization--period--head"),S=await oe(),ae.matches){if(o.classList.add("show"),!R)return;const a=R.lenisInstance;if(!a)return;const s=document.querySelector(".viz-mapa"),c=s.closest(".pin-spacer")??s;let n=0,r=c;for(;r;)n+=r.offsetTop,r=r.offsetParent;a.scrollTo(n,{immediate:!0}),setTimeout(()=>{T()},500)}else t.classList.remove("show"),t.classList.add("hide"),o.classList.add("show");await z("#header","componets/header-interior.html"),H=document.querySelector(".link-back"),H.addEventListener("click",_e),Y(),window.addEventListener("change",Y),S.slideTo(parseInt(e)-1),setTimeout(()=>{document.querySelector("body").className="panel-3"},500)},_e=async()=>{const e=document.querySelector(".visualization"),t=document.querySelector(".main-periods");e.classList.add("show"),e.classList.remove("hide"),t.classList.remove("show"),document.querySelector("body").classList.remove("panel-3"),await z("#header","componets/header.html"),S&&(S.destroy(!0,!0),S=null),A()},Re=()=>{const e=document.querySelectorAll(".yellow-dot"),t=document.querySelectorAll(".gold-dot"),o=document.querySelector(".visualization"),a=document.querySelector(".visualization--ring--head"),s=document.querySelector(".visualization--resume");document.querySelector(".header");const c={27:{day:"57",date:"26 Feb, 2024",emotion:"Excited/Motivated",location:"Austria/United Kingdom"},26:{day:"49",date:"18 Feb, 2024",emotion:"Confused",location:"Austria",resume:`<ul><li>At the Iceland Airport</li>
